    ...
    social: [
      {
        id: 1,
        name: 'Twitter',
        href: 'https://twitter.com/axoswapdev',
        icon: (props) => (
      ...
      },
      {
        ...
        name: 'Discord',
        href: 'https://discord.gg/5MVsX6QQM9',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <footer>
        <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          {navigation.social.map((item) => (
              <a key={item.id} href={item.href} className="text-rose hover:text-gray-500">
          ...
          <p key={item.id} className="mt-8 text-center text-rose font-PhantomRush text-5xl">&copy; {item.text}</p>
          ))}
          </div>
        </div>
      </footer>
